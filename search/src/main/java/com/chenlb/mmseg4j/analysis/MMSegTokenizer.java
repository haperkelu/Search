...
//			/aa.setTermBuffer(word.getSen(), word.getWordOffset(), word.getLength());
			termAtt.append(new String(word.getSen()), word.getWordOffset(), word.getWordOffset() + word.getLength());
